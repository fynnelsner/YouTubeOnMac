        ...
        let fullscreenScript = WKUserScript(
            ...
            (function() {
                ...
                const initStyle = () => {
                    ...
                    s.id = cls;
                    s.textContent = `html.${cls},body.${cls}{overflow:hidden!important;background:#000!important}html.${cls} ytd-masthead,html.${cls} #secondary,html.${cls} #chat,html.${cls} #below,html.${cls} #comments{display:none!important}html.${cls} ytd-watch-flexy #primary{margin:0!important;width:100%!important;max-width:100%!important;padding:0!important}html.${cls} ytd-watch-flexy #primary.ytd-watch-flexy{padding:0!important}.html5-video-player.${cls}-p{position:fixed!important;top:0!important;left:0!important;width:100vw!important;height:100vh!important;z-index:2147483647!important;background:#000!important;display:flex!important;align-items:center!important;justify-content:center!important}.html5-video-player.${cls}-p .html5-video-container{position:fixed!important;inset:0!important;width:100vw!important;height:100vh!important;display:flex!important;align-items:center!important;justify-content:center!important;transform:none!important;margin:0!important;padding:0!important;border:none!important}.html5-video-player.${cls}-p video{max-width:100vw!important;max-height:100vh!important;width:auto!important;height:auto!important;object-fit:contain!important;margin:auto!important;padding:0!important}`;
